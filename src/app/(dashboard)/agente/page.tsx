...
const TOUR_AGENTE = [
  {
    ...
    description:
      "Controle se o agente responde automaticamente às mensagens recebidas no WhatsApp.",
  ...
  },
  {
    ...
    description:
      "Configure identidade, instruções de comportamento, base de conhecimento e visualize o prompt final gerado.",
    position: "bottom" as const,
  },
  {
    ...
    description:
      "Veja exatamente o que o agente recebe como instrução — combinando todas as configurações em um único prompt.",
    position: "bottom" as const,
  },
];
...
function gerarPromptFinal(config: Config, docs: Documento[]): string {
  ...
  if (config.agente_fluxo_qualificacao)
    partes.push(
      `\n--- FLUXO DE QUALIFICAÇÃO ---\nSiga estas etapas em ordem:\n${config.agente_fluxo_qualificacao}`,
    );
  if (config.agente_exemplos_dialogo)
    partes.push(
  ...
  if (docsAtivos.length > 0) {
    partes.push(
      `\n--- BASE DE CONHECIMENTO ---\n` +
        docsAtivos
          .map((d) => `[${d.tipo.toUpperCase()}] ${d.nome}:\n${d.conteudo}`)
          .join("\n\n"),
    );
  }
...
export default function AgentePage() {
  const {
    ...
    next: tourNext,
    finish: tourFinish,
  } = useOnboarding("agente");
  const [activeTab, setActiveTab] = useState<
    "identidade" | "instrucoes" | "conhecimento" | "preview"
  >("identidade");
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-muted)", fontSize: "13px" }}>
            Configure o treinamento e comportamento do agente
          </p>
        </div>
        <div
          data-tour="agente-toggle"
        ...
        >
          ...
          >
            ...
            <div
              onClick={() =>
                setConfig((p) => ({ ...p, agente_ativo: !p.agente_ativo }))
              }
              style={{
                width: "40px",
                height: "22px",
                borderRadius: "11px",
                background: config.agente_ativo ? "#22c55e" : "var(--bg-hover)",
                cursor: "pointer",
                position: "relative",
            ...
            >
              <div
                style={{
                  position: "absolute",
                  top: "3px",
                  left: config.agente_ativo ? "21px" : "3px",
                  width: "16px",
                  height: "16px",
                  borderRadius: "50%",
                  background: "#fff",
        ...
        <div>
          <div style={cardStyle}>
            ...
            >
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfig((p) => ({ ...p, agente_nome: e.target.value }))
                  }
                  placeholder="Ex: Ana"
                />
              </div>
              <div>
                ...
                <select
                  style={inputStyle}
                  value={config.agente_tom}
                  onChange={(e) =>
                    setConfig((p) => ({ ...p, agente_tom: e.target.value }))
                  }
                >
                  {TOM_OPTIONS.map((o) => (
            ...
            <div>
              ...
              <select
                style={inputStyle}
                value={config.agente_foco}
                onChange={(e) =>
                  setConfig((p) => ({ ...p, agente_foco: e.target.value }))
                }
              >
                {FOCO_OPTIONS.map((o) => (
                  <option key={o.value} value={o.value}>
          ...
          <div style={cardStyle}>
            ...
            >
              <div>
                ...
                <input
                  type="time"
                  style={inputStyle}
                  value={config.agente_horario_inicio}
                  onChange={(e) =>
                    setConfig((p) => ({
                      ...p,
                      agente_horario_inicio: e.target.value,
                    }))
                  }
                />
              </div>
              <div>
                ...
                <input
                  type="time"
                  style={inputStyle}
                  value={config.agente_horario_fim}
                  onChange={(e) =>
                    setConfig((p) => ({
                      ...p,
                      agente_horario_fim: e.target.value,
                    }))
                  }
                />
              </div>
            ...
            >
              <input
                type="checkbox"
                checked={config.agente_apenas_dias_uteis}
                onChange={(e) =>
                  setConfig((p) => ({
                    ...p,
                    agente_apenas_dias_uteis: e.target.checked,
                  }))
                }
              />
              <span
        ...
        <div>
          ...
          >
            <div>
              ...
              >
                Preenche automaticamente com um prompt otimizado para advocacia
                previdenciária
              </p>
            </div>
            <button
          ...
          <div style={cardStyle}>
            ...
            >
              Instruções principais. Variáveis disponíveis:{" "}
              <code
                style={{
            ...
            <textarea
              ...
              onChange={(e) =>
                setConfig((p) => ({
                  ...p,
                  agente_prompt_sistema: e.target.value,
                }))
              }
          ...
          <div style={cardStyle}>
            ...
            >
              Defina as etapas em ordem que o agente deve seguir para qualificar
              e converter o lead. Seja específico: etapa 1, etapa 2...
            </p>
            <textarea
          ...
          <div style={cardStyle}>
            ...
            >
              Cole exemplos reais de boas e más respostas. Isso é o que mais
              melhora a qualidade do agente — mostre o que fazer e o que NÃO
              fazer.
            </p>
            <textarea
              style={{ ...inputStyle, minHeight: "180px", resize: "vertical" }}
              ...
              onChange={(e) =>
                setConfig((p) => ({
                  ...p,
                  agente_exemplos_dialogo: e.target.value,
                }))
              }
              placeholder={
                "✅ BOM: Lead pergunta valor → Agente explica que depende da análise e propõe consulta\n❌ RUIM: Agente promete valor específico antes de analisar o caso"
              }
            />
          </div>
          ...
          <div style={cardStyle}>
            ...
            >
              Uma frase ou situação por linha. Quando o lead escrever algo
              assim, o agente para e notifica a advogada para assumir.
            </p>
            <textarea
              ...
              onChange={(e) =>
                setConfig((p) => ({
                  ...p,
                  agente_gatilhos_escalada: e.target.value,
                }))
              }
              placeholder={
          ...
          <div style={cardStyle}>
            ...
            >
              Uma por linha. O agente nunca usará essas frases — importante para
              compliance com a OAB.
            </p>
            <textarea
              ...
              onChange={(e) =>
                setConfig((p) => ({
                  ...p,
                  agente_frases_proibidas: e.target.value,
                }))
              }
              placeholder={
          ...
          <div style={cardStyle}>
            ...
            >
              O que o agente responde quando não entende a mensagem ou ela está
              fora do escopo.
            </p>
            <textarea
              ...
              onChange={(e) =>
                setConfig((p) => ({ ...p, agente_fallback: e.target.value }))
              }
          ...
          <div style={cardStyle}>
            ...
            >
              Instrua o agente sobre como responder às objeções mais comuns dos
              leads.
            </p>
            <textarea
              style={{ ...inputStyle, minHeight: "120px", resize: "vertical" }}
      ...
      {activeTab === "conhecimento" && (
        <div>
          ...
          >
            ...
            >
              {docs.filter((d) => d.ativo).length} documento(s) ativo(s) —
              injetados no contexto do agente
            </p>
            <button
            ...
            <div style={{ ...cardStyle, border: "1px solid var(--accent)" }}>
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    value={docForm.nome}
                    onChange={(e) =>
                      setDocForm((p) => ({ ...p, nome: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    value={docForm.tipo}
                    onChange={(e) =>
                      setDocForm((p) => ({ ...p, tipo: e.target.value }))
                    }
                  >
              ...
              <div style={{ marginBottom: "12px" }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setDocForm((p) => ({ ...p, descricao: e.target.value }))
                  }
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setDocForm((p) => ({ ...p, conteudo: e.target.value }))
                  }
          ...
          {docs.length === 0 && !showDocForm && (
            <div style={{ ...cardStyle, textAlign: "center", padding: "48px" }}>
              ...
              >
                Adicione scripts, manuais, FAQ ou legislação para treinar o
                agente
              </p>
            </div>
          )}
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  >
                    {TIPO_DOC_OPTIONS.find((t) => t.value === doc.tipo)
                      ?.label || doc.tipo}
                  </span>
                </div>
                {doc.descricao && (
              ...
              >
                <div
                  onClick={() => toggleDoc(doc.id, !doc.ativo)}
                  style={{
                    width: "36px",
                    height: "20px",
                    borderRadius: "10px",
                    background: doc.ativo ? "#22c55e" : "var(--bg-hover)",
                    cursor: "pointer",
                    position: "relative",
                    flexShrink: 0,
                  }}
        ...
        <div style={cardStyle}>
          ...
          >
            <div>
              ...
              >
                Exatamente o que será enviado ao Claude como contexto
              </p>
            </div>
            <span
              style={{
          ...
          >
            {gerarPromptFinal(config, docs) ||
              "(prompt vazio — configure as abas Identidade e Instruções)"}
          </pre>
        </div>
      )}
    </div>
