...
export default function LeadDetailPage() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      const upRes = await fetch(`/api/leads/${id}/documentos/upload`, {
        method: "POST",
        body: fd,
      });
  ...
  async function handleDeleteDoc(docId: string) {
    ...
    await fetch(`/api/leads/${id}/documentos?docId=${docId}`, {
      method: "DELETE",
    });
    fetchDocumentos();
  }
            ...
            >
              <div>
                ...
                <input
                  value={docForm.nome}
                  onChange={(e) =>
                    setDocForm((f) => ({ ...f, nome: e.target.value }))
                  }
                  placeholder="Ex: CNIS atualizado"
                  style={inputSt}
                />
              </div>
              <div>
                ...
                <select
                  value={docForm.tipo}
                  onChange={(e) =>
                    setDocForm((f) => ({ ...f, tipo: e.target.value }))
                  }
                  style={inputSt}
                >
                  {TIPOS_DOC.map((t) => (
            ...
            >
              ...
              {selectedFile ? (
                ...
                <div>
                  ...
                  >
                    PDF, Word, imagens, planilhas — até 20MB
                  </p>
                </div>
              )}
            </div>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  color: "#fff",
                  background:
                    !selectedFile || !docForm.nome || uploadingDoc
                      ? "#2a2f45"
                      : "var(--accent)",
                  border: "none",
                  borderRadius: "8px",
