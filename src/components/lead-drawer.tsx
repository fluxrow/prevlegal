          ...
          <>
            ...
            >
                ...
                >
                  <div
                    style={{
                      ...
                      fontWeight: "800",
                      fontFamily: "Syne, sans-serif",
                      color: lead.score >= 80 ? "#2dd4a0" : "#f5c842",
                    }}
                  >
                    {lead.score}
                  </div>
              ...
              >
                ...
                Ver perfil completo — documentos, calculadora, IA e honorários
              </button>
            </div>
            ...
            >
              ...
              <Section title="Pagamento" icon={CreditCard}>
                ...
                {lead.bloqueado && (
                  ...
                  >
                    ...
                    <span style={{ fontSize: "12px", color: "#ff5757" }}>
                      Benefício bloqueado
                    </span>
                  </div>
                )}
              ...
              <Section
                title={`Anotações (${anotacoes.length})`}
                ...
                <div style={{ marginBottom: "10px" }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontSize: "12px",
                      cursor: novaAnotacao.trim() ? "pointer" : "not-allowed",
                      fontFamily: "Syne, sans-serif",
                      fontWeight: "600",
                      display: "flex",
                      alignItems: "center",
